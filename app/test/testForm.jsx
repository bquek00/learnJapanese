...
export default function Test({data}) {
    ...
    return(
        ...
        <div className="relative bottom-0 left-0 right-0 top-0 h-full w-full overflow-scroll bg-fixed bg-black/[.6] flex justify-center">
            ...
            <div className={`${Object.keys(data).length > 1 && !test ? "flex" : "hidden"} absolute top-basic flex-col
            lg:flex-row items-center justify-center`}>
                <label className="text-lg lg:text-4xl text-white  w-auto px-3
                block mb-2 font-medium text-gray-900 dark:text-white text-center">Select how many questions</label>
                <select className="w-auto self-start bg-gray-50 border border-gray-300 text-gray-900 
                text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 
                dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 
                dark:focus:border-blue-500 mx-auto"
            ...
            text-white absolute top-basic mt-24 lg:mt-20 bg-blue-700 hover:bg-blue-800 focus:ring-4 
